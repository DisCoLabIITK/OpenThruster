...
elseif Thickness==1 | strcmp(Thickness,'NACA 001612') %--Use NACA 001612 thickness form
       Thickness =                      'NACA 001612';  
elseif Thickness==1 | strcmp(Thickness,'NACA 001615') %--Use NACA 001615 thickness form
       Thickness =                      'NACA 001615'; 
...
if strcmp(Thickness,'NACA 65A010')   
 ...
 % ---------------------------------------------- NACA 0016-12 thickness form
elseif strcmp(Thickness,'NACA 001612')   
    
    xoc = [0 1.25 2.5 5 7.5 10 15 20 30 40 50 ...
          60 70 80 90 95 100]./100;
      
    toc = [0 1.292 1.805 2.509 3.032 3.457 4.135 4.664 5.417 5.855 ...
              6 5.835 5.269 4.199 2.517 1.415 0.12]./100;
    ...
    As0  = 0.703;  % == trapz(x0,tot0), with x0 = 0:0.00001:1;  cross-sectional area for c == t0 == 1   
    
 % ---------------------------------------------- NACA 0016-12 thickness form
elseif strcmp(Thickness,'NACA 001615')   
    
    xoc = [0 1.25 2.5 5 7.5 10 15 20 30 40 50 ...
          60 70 80 90 95 100]./100;
      
    toc = [0 1.615 2.257 3.317 3.79 4.322 5.168 5.830 6.772 7.318 ...
              7.5 7.293 6.587 5.248 3.147 1.1768 0.15]./100;
    ...
    As0  = 1.1;  % == trapz(x0,tot0), with x0 = 0:0.00001:1;  cross-sectional area for c == t0 == 1  
