...
function OpenPropSingle
    ...
    % ========================== Initiate Main Figure =========================
     Meanline_cell   = {'NACA a=0.8' 'NACA a=0.8 (modified)' 'Parabolic' 'flat'};
    Thickness_cell   = {'NACA 65A010' 'NACA 65A010 (modified)' 'Elliptical' 'Parabolic' 'NACA 66 (DTRC modified)' 'NACA 001612' 'NACA 001615'};
...
%     Selectcell      = {'Single Design','Parametric Study','Off-design Analysis'};
    ...
    FlagValues(4)     = uicontrol(Duct,'units','characters','style','checkbox',...
                                  'string','','position',[1 Ductboxht-8-textht...
